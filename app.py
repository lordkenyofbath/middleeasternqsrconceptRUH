...
# We inject custom CSS to force the "Industrial/Dark" vibe and hide default Streamlit elements
st.markdown("""
    <style>
...
# --- SVG ASSETS ---
# The SVG code we generated earlier, slightly optimized for Python string injection
HERO_SVG = """
